!(function () {
  ...
  function ListService() {
    ...
    var details = [
      {
        name: "First project",
        description: "developed first",
        status: "completed",
        link: "#",
      },
      {
        name: "Second project",
        description: "developed second",
        status: "completed",
        link: "#",
      },
      {
        name: "Third project",
        description: "developed third",
        status: "initiated",
        link: "#",
      },
      {
        name: "Fourth project",
        description: "developed fourth",
        status: "in progress",
        link: "#",
      },
      {
        name: "Fifth project",
        description: "developed fifth",
        status: "in progress",
        link: "#",
      },
      {
        name: "Sixth project",
        description: "developed sixth",
        status: "in review",
        link: "#",
      },
    ];
